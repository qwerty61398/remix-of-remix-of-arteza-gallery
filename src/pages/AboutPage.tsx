        ...
        <div className="container px-6 text-center">
          <ScrollReveal variant="blur-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" <Button asChild variant="outline" size="lg" className="text-base border-white/30 text-foreground bg-white hover:bg-white/90">>
